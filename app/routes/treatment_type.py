...
def create(TreatmentType: schemas.CreateTreatmentType = Depends(schemas.CreateTreatmentType.as_form), db: Session = Depends(get_db),  current_user: schemas.User = Depends(oauth2.get_current_user)):
...
def update(id, TreatmentType: schemas.CreateTreatmentType = Depends(schemas.CreateTreatmentType.as_form), db: Session = Depends(get_db),  current_user: schemas.User = Depends(oauth2.get_current_user)):
