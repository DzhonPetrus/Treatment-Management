...
def all(request: Request, db: Session = Depends(get_db)):
    ...
    return templates.TemplateResponse("treatment_type.html", {"request":request, "treatment_types": jsonable_encoder(treatment_type.get_all(db)), 'current_path': request.url.path})