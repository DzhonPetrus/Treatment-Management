...
def create(LabTest: schemas.CreateLabTest = Depends(schemas.CreateLabTest.as_form), db: Session = Depends(get_db),  current_user: schemas.User = Depends(oauth2.get_current_user)):
...
def update(id, LabTest: schemas.CreateLabTest = Depends(schemas.CreateLabTest.as_form), db: Session = Depends(get_db),  current_user: schemas.User = Depends(oauth2.get_current_user)):
